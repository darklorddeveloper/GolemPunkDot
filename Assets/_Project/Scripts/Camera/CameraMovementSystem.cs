    ...
    public partial class CameraMovementSystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            if (isChangingAngle)
            {
                ...
                if (isChangingAngle == false)
                {
                    cam.cameraRootTransform.position = camMovement.position;
                    cam.cameraRootTransform.rotation = Quaternion.Euler(camMovement.eulerRotation);
                }
                else
                {
